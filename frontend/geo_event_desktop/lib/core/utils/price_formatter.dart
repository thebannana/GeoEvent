...
class PriceFormatter {
  ...
  static String format(
    ...
    final normalized = _normalizeValue(value, decimalDigits);

    switch (style) {
      case PriceDisplayStyle.plain:
        return NumberFormat.decimalPattern(locale).format(normalized);
      ...
      case PriceDisplayStyle.symbolTrailing:
        final number = NumberFormat.decimalPattern(locale).format(normalized);
        return '$number ${_symbolFor(currency)}';
